...
const Amain = () => {
  ...
  const [isTemporaryPolygonMode, setIsTemporaryPolygonMode] = useState(false);
  const [temporaryPolygons, setTemporaryPolygons] = useState([]);
  ...
  useEffect(() => {
    if (activeMenu !== 'mapmanage') {
      ...
      setIsTemporaryPolygonMode(false);
    }
  }, [activeMenu]);
  ...
  useEffect(() => {
    ...
    const sourceId = 'temporary-polygons';
    const fillLayerId = 'temporary-polygons-fill';
    const outlineLayerId = 'temporary-polygons-outline';

    const visibility = isTemporaryPolygonMode ? 'visible' : 'none';
    const data = {
      type: 'FeatureCollection',
      features: temporaryPolygons
    };
  ...
  }, [map, activeMenu, temporaryPolygons, isTemporaryPolygonMode]);
  ...
  const handleTemporaryPolygonToggle = () => {
    setIsTemporaryPolygonMode((current) => {
      const nextState = !current;
      setOpenSubMenu(nextState ? 'temporary-polygon' : null);
      return nextState;
    });
  ...
  const handleAddTemporaryPolygon = () => {
    if (!map) return;
    ...
    setTemporaryPolygons((prev) => [...prev, polygonFeature]);
    setIsTemporaryPolygonMode(true);
    setOpenSubMenu('temporary-polygon');
  };

  const handleClearTemporaryPolygons = () => {
                ...
                {/* Top Left - Map Type Selector */}
                  ...
                  <div className="action-buttons-group">
                    <div className={`action-button ${openSubMenu === 0 ? 'selected' : ''}`}
                      onClick={() => {
                        setOpenSubMenu(openSubMenu === 0 ? null : 0);
                        setIsTemporaryPolygonMode(false);
                      }}>
                      <span>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="temporary-polygon-stack">
                      <div className={`action-button ${isTemporaryPolygonMode ? 'selected' : ''}`}
                        onClick={handleTemporaryPolygonToggle}>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M4.25 6.25L9.75 2.75L15.75 6.25V13.75L9.75 17.25L4.25 13.75V6.25Z" stroke={isTemporaryPolygonMode ? 'white' : '#1E2023'} strokeWidth="1.5" strokeLinejoin="round" />
                          <path d="M7.5 9.5L9.75 11.75L13 8.5" stroke={isTemporaryPolygonMode ? 'white' : '#1E2023'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                      </div>
                      {openSubMenu === 'temporary-polygon' && (
                        <div className="sub-buttons0">
                          <button className="sub-btn" onClick={handleAddTemporaryPolygon}>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M4.25 6.25L9.75 2.75L15.75 6.25V13.75L9.75 17.25L4.25 13.75V6.25Z" stroke="#1E2023" strokeWidth="1.5" strokeLinejoin="round" />
                              <path d="M9.75 7.5V12.5" stroke="#1E2023" strokeWidth="1.5" strokeLinecap="round" />
                              <path d="M7.25 10H12.25" stroke="#1E2023" strokeWidth="1.5" strokeLinecap="round" />
                            </svg>
                          </button>
                          <button className="sub-btn" onClick={handleClearTemporaryPolygons}>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M5.5 6H14.5" stroke="#C1121F" strokeWidth="1.5" strokeLinecap="round" />
                              <path d="M7.25 6V4.75C7.25 4.33579 7.58579 4 8 4H12C12.4142 4 12.75 4.33579 12.75 4.75V6" stroke="#C1121F" strokeWidth="1.5" />
                              <path d="M6.5 6.5L7 15C7.04138 15.6331 7.56694 16.125 8.20065 16.125H11.7994C12.4331 16.125 12.9586 15.6331 13 15L13.5 6.5" stroke="#C1121F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                              <path d="M9 9.25V13.25" stroke="#C1121F" strokeWidth="1.5" strokeLinecap="round" />
                              <path d="M11 9.25V13.25" stroke="#C1121F" strokeWidth="1.5" strokeLinecap="round" />
                            </svg>
                          </button>
                        </div>
                      )}
